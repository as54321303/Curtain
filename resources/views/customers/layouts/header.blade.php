 ...
 <header class="header-section d-none d-xl-block">
    <div class="header-wrapper">
        <!-- Start Header Top -->
        <div class="header-top header-top-bg--white section-fluid px-0 py-3">
                ...
                <div class="col-12 d-flex align-items-center justify-content-between">
                    <div class="header-top-left">
                        <div
                            ...
                            <a href="tel:0123456789" class="icon-space-right"><i
                                    class="icon-call-in"></i>+91 8975462351</a>
                            <a href="mailto:demo@example.com" class="icon-space-right"><i
                                    class="icon-envelope"></i>curtain@curtain.com</a>
                        </div>
                    </div>
                    ...
                    <div class="header-top-right">
                        ...
                        <ul class="header-action-link action-color--black action-hover-color--aqua">
                            <li>
                                <a href="{{ route('customers.cart') }}"> <!-- Removed Class: class="offcanvas-toggle" -->
                                    <i class="icon-bag"></i>
                                    @if (session()->has('user_id'))
                                    <span class="item-count" id="cart_value">{{ session()->get('cart_value') }}</span>
                                    @else
                                    <span class="item-count" id="cart_value">{{ count(session()->get('cart_value')) }}</span>
                                    @endif
                                </a>
                            </li>
                            @if (session()->has('user_id')) 
                            <li>
                                <a style="letter-spacing: -1px; font-size: 17px">Welcome {{ session()->get('user_name'); }}</a>
                            </li>
                            <li>
                                <a href="{{ route('customers.logout') }}" style="letter-spacing: -1px; font-size: 19px">Logout</a>
                            </li>
                            @else
                            <li>
                                <a href="{{ route('customers.login') }}" style="letter-spacing: -1px; font-size: 19px">Login</a>
                            </li>
                            <li>
                                <a href="{{ route('customers.signup') }}" style="letter-spacing: -1px; font-size: 19px">Signup</a>
                            </li>
                            @endif
                        </ul>
                    ...
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        ...
                        <div class="main-menu main-menu-style-4 menu-color--white menu-hover-color--aqua">
                            <nav>
                                <ul>
                                    <li>
                                        <a class="active main-menu-link" href="{{ route('customer.welcome') }}">Home </a>
                                    </li>
                                    <li class="has-dropdown has-megaitem">
                                        <a href="{{ route('customer.welcome') }}">Shop <i
                                        ...
                                        <div class="mega-menu">
                                            <ul class="mega-menu-inner">
                                                ...
                                                <li class="mega-menu-item">
                                                    <a href="#" class="mega-menu-item-title">Curtains</a>
                                                    <ul class="mega-menu-sub">
                                                        <li><a href="#">Curtain 1</a></li>
                                                        <li><a href="#">Curtain 2</a></li>
                                                        <li><a href="#">Curtain 3</a></li>
                                                        <li><a href="#">Curtain 4</a></li>
                                                        <li><a href="#">Curtain 5</a></li>
                                                    </ul>
                                                </li>
                                                <!-- Mega Menu Sub Link -->
                                                <li class="mega-menu-item">
                                                    <a href="#" class="mega-menu-item-title">Blinders</a>
                                                    <ul class="mega-menu-sub">
                                                        <li><a href="#">Blinders 1</a></li>
                                                        <li><a href="#">Blinders 2</a></li>
                                                        <li><a href="#">Blinders 3</a></li>
                                                        <li><a href="#">Blinders 4</a></li>
                                                        <li><a href="#">Blinders 5</a></li>
                                                    </ul>
                                                </li>
                                                <!-- Mega Menu Sub Link -->
                                                <li class="mega-menu-item">
                                                    <a href="#" class="mega-menu-item-title">Others</a>
                                                    <ul class="mega-menu-sub">
                                            ...
                                            <div class="menu-banner">
                                                {{-- Image here to show on shop dropdown --}}
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <a href="{{ route('customers.aboutus') }}">About Us</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('customers.contactus') }}">Contact Us</a>
                                    </li>
                                    @if (session()->has('user_id'))
                                    <li>
                                        <a href="{{ route('customers.myorders') }}">My Orders</a>
                                    </li>
                                    @endif
                                </ul>
                            </nav>
    ...
    <div class="offcanvas-mobile-menu-wrapper">
        ...
        <div class="mobile-menu-bottom">
            ...
            <div class="offcanvas-menu">
                <ul>
                    <li>
                        <a href="{{ route('customer.welcome') }}"><span>Home</span></a>
                    </li>
                    <li>
